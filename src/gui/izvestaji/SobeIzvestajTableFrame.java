...
import model.SobeIzvestajModel;

public class SobeIzvestajTableFrame extends JFrame{
	...
	public SobeIzvestajTableFrame(JFrame parent, RezervacijeManager rezervacijeManager, SobeManager sobeManager,
		...
		// podesavanje tabele
		table = new JTable(new SobeIzvestajModel(rezervacijeManager, sobeManager, pocetniDatum, krajnjiDatum));		
