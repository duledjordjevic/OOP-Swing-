...
//	#id; username; tip sobe; pocetni datum; krajnji datum; status rezervacije
	...
	public CheckOutModel(RezervacijeManager rezervacijeManager, SobeManager sobeManager) {
	...
	public int getRowCount() {
		...
		for(Rezervacija rez: rezervacijeManager.getRezervacije()) {
			if(rez.getStatusRezervacije().equals(StatusRezervacije.POTVRDJENA) & rez.getKrajnjiDatum().isEqual(today)) {
